...
public class LetterOperation extends JFrame {
	...
	public LetterOperation() {
		...
		countLettersbutton.addActionListener(new CountLetterListener(inputfield,outputfield));
		reverseLettersbutton.addActionListener(new ReverseLetterListener(inputfield,outputfield));
		removeDuplicatebutton.addActionListener(new RemoveDuplicateListener(inputfield,outputfield));
	
	}

	//define the listener class
	public class CountLetterListener implements ActionListener {
		//the text field we are listening to
		private JTextField inputfield;
		public CountLetterListener(JTextField inputfield,JTextField outputfield) {
	...
	//define the listener class
		public class ReverseLetterListener implements ActionListener {
			//the text field we are listening to
			private JTextField inputfield;
			private JTextField ouputfield;
			public ReverseLetterListener(JTextField inputfield,JTextField outputfield) {
		...
		//define the listener class
		public class RemoveDuplicateListener implements ActionListener {
			//the text field we are listening to
			private JTextField inputfield;
			public RemoveDuplicateListener(JTextField inputfield, JTextField outputfield) {
